...
/**
 * No Stitch mockup exists for Login (see PROJECT_STATUS.md §3.3 — F-AUTH-01
 * has no design screen). Built with the same design tokens as the rest of
 * the app (tailwind.config.js) rather than inventing a new visual style.
 */
  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-surface px-margin-mobile">
      <div className="w-full max-w-sm rounded-xl bg-surface-container p-space-md shadow-2xl flex flex-col gap-space-md">
        ...
        {justVerified && (
          <p className="font-body-sm text-body-sm text-primary bg-primary/10 rounded-lg px-3 py-2">
            Akun terverifikasi. Silakan masuk.
          </p>
        )}
